...
class Process implements Runnable {
    ...
    // Feature 1: getter to access process priority
...
public class SchedulerSimulation {
    static int contextSwitches = 0;// Feature 2: counter for number of context switches
    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445050275;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        while (!processQueue.isEmpty()) {
            ...
            contextSwitches++; // Feature 2: increment context switch each time a process starts execution
